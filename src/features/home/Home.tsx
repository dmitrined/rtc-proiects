...
export default function Home(): JSX.Element {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[calc(100vh-64px)] bg-linear-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20 p-6 text-center overflow-hidden transition-all duration-300">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <h1 className="text-6xl md:text-7xl font-bold bg-linear-to-r from-blue-600 via-indigo-600 to-purple-600 dark:from-blue-400 dark:via-indigo-400 dark:to-purple-400 bg-clip-text text-transparent mb-6 leading-tight animate-fade-in">
          {t.welcome}
        </h1>

        <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto mb-4 font-light">
          {t.description}{" "}
          <span className="font-bold bg-linear-to-r from-blue-600 to-cyan-600 dark:from-blue-400 dark:to-cyan-400 bg-clip-text text-transparent">
            {t.react}
          </span>{" "}
          {t.and}{" "}
          <span className="font-bold bg-linear-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent">
            {t.projects}
          </span>
        </p>
        ...
        <div className="inline-block backdrop-blur-lg bg-white/70 dark:bg-gray-800/70 py-4 px-8 rounded-2xl shadow-2xl border border-white/20 dark:border-gray-700/50 hover:scale-105 transition-transform duration-300">
          <p className="text-lg font-semibold bg-linear-to-r from-red-600 to-pink-600 dark:from-red-400 dark:to-pink-400 bg-clip-text text-transparent">
            {t.loginPrompt}
          </p>
        </div>
      </div>
